...
var WebhookResource = (function (_super) {
    __extends(WebhookResource, _super);
    function WebhookResource(shipstation) {
        var _this = _super.call(this, shipstation, 'webhookResource') || this;
        _this.shipstation = shipstation;
        return _this;
    }
    WebhookResource.prototype.getResource = function (data) {
